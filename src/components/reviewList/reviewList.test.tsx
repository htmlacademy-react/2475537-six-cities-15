...
describe('ReviewList', () => {
  ...
  it('should fetch reviews on ReviewList component', async () => {
  ...
  it('should render ReviewList component with reviews', async () => {
  ...
  it('should render ReviewList component with reviewForm', async () => {
    const { withStoreComponent } = withStore(<ReviewList offerId={offerId} />, makeFakeStore({
      [Namespace.User]: {
